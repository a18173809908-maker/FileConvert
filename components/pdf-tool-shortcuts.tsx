...
import { Archive, Files, Lock, RotateCw, Scissors, Unlock } from 'lucide-react'
...
const tools: Array<{
  ...
  { id: 'compress', label: 'PDF 压缩', description: '轻量优化文件体积', icon: Archive },
    ...
    <section className="rounded-lg border border-border bg-card px-5 py-4">
      <div className="mb-3 flex items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">压缩、加密、解密、合并、拆分、旋转，直接处理 PDF 文件</p>
        </div>
      </div>
